...
export default function WorkoutCard({
  ...
  if (workout.isRest) {
    return (
      <div className="bg-gradient-to-br from-blue-400 via-cyan-400 to-teal-400 rounded-3xl p-8 md:p-12 text-center text-white shadow-2xl animate-fadeIn overflow-hidden relative">
